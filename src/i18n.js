...
const resources = {
  en: {
    translation: {
      ...
      "CHF / month": "CHF / month",
      "CHF / Year": "CHF / Year",
      "head phrase one": "With COMPAREPRIME find your health insurance from 144 CHF/Month and for an Adult.",
      "head phrase two": "with COMPAREPRIME, you will find the cheapest insurance in just a few clicks.",
  ...
  fr: {
    translation: {
      ...
      "CHF / month": "CHF / mois",
      "CHF / Year": "CHF / an",
      "head phrase one": "Avec COMPAREPRIME trouvez votre assurance maladie à partir de 144 CHF/Mois et pour un Adulte.",
      "head phrase two": "avec COMPAREPRIME, vous trouverez l'assurance la moins chère en quelques cliques seulement.",
      "services title": "intéressé(e)",
  ...
  de: {
    translation: {
      ...
      "CHF / month": "CHF / Monat",
      "CHF / Year": "CHF / Jahre",
      "head phrase one": "Mit COMPAREPRIME finden Sie Ihre Krankenversicherung ab 144 CHF/Monat und für einen Erwachsenen",
      "head phrase two": "Mit COMPAREPRIME finden Sie mit wenigen Klicks die günstigste Versicherung.",
  ...
  it: {
    translation: {
      ...
      "CHF / month": "CHF / mese",
      "CHF / Year": "CHF / anni",
      "head phrase one": "Con COMPAREPRIME trovi la tua assicurazione sanitaria a partire da 144 CHF/mese e per un adulto",
      "head phrase two": "con COMPAREPRIME trovi l'assicurazione più conveniente in pochi click.",
